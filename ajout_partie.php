...
<form method="post" action="ajout_partie.php">
	...
	<br><br>
	<input type="text" placeholder="createur de la partie" name="createur">
	<br><br>
...
if(!empty($_POST["date_debut"]))
	{
		if (!empty($_POST["password"]))
			{
				if (newGame($_POST["nom"], $_POST["createur"], $_POST["date_debut"], $_POST["date_fin"], $_POST["password"]) == false)
					echo "probleme";
			}
		else
			{
				if (newGame($_POST["nom"], $_POST["createur"], $_POST["date_debut"], $_POST["date_fin"], 'NULL') == false)
					echo "probleme";
			}
	}
?>